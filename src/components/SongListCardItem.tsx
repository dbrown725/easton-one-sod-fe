                    ...
                    <IonLabel>
                      <h1 title={sanitizeData(props.songWrapper.song.songName)}
                        dangerouslySetInnerHTML={{
                          __html: props.songWrapper.song.songNameHighlighted ?
                      ...
                      <p dangerouslySetInnerHTML={{
                        __html: props.songWrapper.song.bandNameHighlighted ?
                          highlightMatches(sanitizeData(props.songWrapper.song.bandNameHighlighted)) : sanitizeData(props.songWrapper.song.bandName)
                      }}></p>
                    </IonLabel>
                  </IonItem>
                </IonCol>
                <IonCol size="4">
                  <IonRow>
                    <IonCol>
                      <div className="title"
                        dangerouslySetInnerHTML={{
                          __html: props.songWrapper.song.titleHighlighted ?
            ...
            <IonGrid>
              ...
              <IonRow>
                <IonCol size="12" className="song-band-col">
                  ...
                  <span className="band-span" dangerouslySetInnerHTML={{
                    __html: props.songWrapper.song.bandNameHighlighted ?
                      highlightMatches(sanitizeData(props.songWrapper.song.bandNameHighlighted)) : sanitizeData(props.songWrapper.song.bandName)
                  }}></span>
                </IonCol>
              ...
              <IonRow className={props.songListProps.showDeleteButton ? "bullpen img-date-buttons-row" : "img-date-buttons-row"}>
                {!props.songListProps.showDeleteButton &&
                  <IonCol size="2" className="avatar-column">
                    <IonAvatar>
                      {(role !== 'GUEST' || !props.songWrapper.song.privacyOn) &&
                        <img
                      ...
                      {role === 'GUEST' && props.songWrapper.song.privacyOn &&
                        <img
                          src={"https://ui-avatars.com/api/?background=0D8ABC&color=fff&name=" + "U" +
                            "+" + props.songWrapper.song.userId + "&rounded=true&background=" + props.songWrapper.song.userAvatarColor}
                          title={"User" + " " + props.songWrapper.song.userId} />
                      }
                    </IonAvatar>
                  </IonCol>
                }
